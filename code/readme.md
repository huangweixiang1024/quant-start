...
./venv311/bin/python -m pip install -U pip setuptools wheel
./venv311/bin/python -m pip install pandas numpy matplotlib akshare yfinance
...
python -m experiments.exp_ma_param
